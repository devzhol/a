...
SECRET_KEY = 'django-insecure-8qo)b96cb0jd(&wdd68ebrch4apcl81tav%1om+riodv_)(qq('
...
MIDDLEWARE = [
    ...
    'goo.middleware.LoginRequiredMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'goo.context_processors.all_users',
            ],
        },
    },
]
...
# For Yandex use smtp.yandex.com with EMAIL_USE_SSL = True, port 465.
